...
forward
global type u_calculator from UserObject
end type
type dw_calculator from datawindow within u_calculator
end type
end forward
...
CHOOSE CASE as_operator
	CASE '/'
		If idbl_operand = 0 Then
			MessageBox('Division', &
				'Division by zero is not valid', Exclamation!)
			Return -1
		Else
...
this.Control[]={ this.dw_calculator}
end on
