...
$PBExportComments$PFC ProgressBar class.  Remove this object when you migrate to PFC 6.0
forward
global type pfc_u_progressbar from UserObject
end type
...
event resize;// expand dw to dimensions of on screen object
