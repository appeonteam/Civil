...
forward
global type n_cst_dropdown from nonvisualobject
end type
end forward
...
ElseIf lenv_object.ostype = Macintosh! Then
	CHOOSE CASE ai_option
		CASE DWSTYLE_BOX
			Return 0
		CASE DWSTYLE_SHADOWBOX
...
//
//	Description:  Updates the position of the requestor object based on the 
//		current location of the adrg_object.  If adrg_object is a datawindow, it
//		is based on the current column/row within the datawindow.
//		*Note: 	Title Bar on datawindows is not supported.
//
//////////////////////////////////////////////////////////////////////////////
//
//	Revision History
