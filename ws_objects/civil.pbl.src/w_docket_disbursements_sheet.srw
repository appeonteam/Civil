$PBExportHeader$w_docket_disbursements_sheet.srw
forward
global type w_docket_disbursements_sheet from w_base_sheet
end type
type sle_lname from singlelineedit within w_docket_disbursements_sheet
end type
type sle_fname from singlelineedit within w_docket_disbursements_sheet
end type
type st_1 from statictext within w_docket_disbursements_sheet
end type
type st_2 from statictext within w_docket_disbursements_sheet
end type
type st_6 from statictext within w_docket_disbursements_sheet
end type
type em_from_date from editmask within w_docket_disbursements_sheet
end type
type em_to_date from editmask within w_docket_disbursements_sheet
end type
type st_7 from statictext within w_docket_disbursements_sheet
end type
type cb_apply from commandbutton within w_docket_disbursements_sheet
end type
type st_3 from statictext within w_docket_disbursements_sheet
end type
type gb_d from groupbox within w_docket_disbursements_sheet
end type
type gb_m from groupbox within w_docket_disbursements_sheet
end type
type cb_main from commandbutton within w_docket_disbursements_sheet
end type
type cb_disburse from commandbutton within w_docket_disbursements_sheet
end type
type cb_disburse_one from commandbutton within w_docket_disbursements_sheet
end type
type st_message from statictext within w_docket_disbursements_sheet
end type
type sle_casenum from singlelineedit within w_docket_disbursements_sheet
end type
type dw_check from datawindow within w_docket_disbursements_sheet
end type
type cb_print_check from commandbutton within w_docket_disbursements_sheet
end type
type st_4 from statictext within w_docket_disbursements_sheet
end type
type sle_checknum from singlelineedit within w_docket_disbursements_sheet
end type
end forward
...
integer width = 3690
integer height = 2067
string title = "Docket Cash Disbursements"
...
sle_casenum sle_casenum
dw_check dw_check
cb_print_check cb_print_check
st_4 st_4
sle_checknum sle_checknum
end type
global w_docket_disbursements_sheet w_docket_disbursements_sheet
...
on w_docket_disbursements_sheet.create
int iCurrent
call super::create
...
this.Control[iCurrent+11]=this.gb_d
this.Control[iCurrent+12]=this.gb_m
this.Control[iCurrent+13]=this.cb_main
this.Control[iCurrent+14]=this.cb_disburse
this.Control[iCurrent+15]=this.cb_disburse_one
this.Control[iCurrent+16]=this.st_message
this.Control[iCurrent+17]=this.sle_casenum
this.Control[iCurrent+18]=this.dw_check
this.Control[iCurrent+19]=this.cb_print_check
this.Control[iCurrent+20]=this.st_4
this.Control[iCurrent+21]=this.sle_checknum
end on

on w_docket_disbursements_sheet.destroy
call super::destroy
...
destroy(this.sle_casenum)
destroy(this.dw_check)
destroy(this.cb_print_check)
destroy(this.st_4)
destroy(this.sle_checknum)
end on
...
date s_dtToPaidDate
integer s_iBusNum
string s_achSSAN, s_achCaseNum, s_achCheckNum
...
s_achCaseNum = Trim(sle_casenum.text)
s_achCheckNum = Trim(sle_checknum.text)
...
If s_achCaseNum <> "" Then
   If Len(s_achSQL) = 0 Then
      s_achSQL = &
         " WHERE sh_docket_disbursement.case_number = ~~~'" + s_achCaseNum + "~~~'" 
   Else 
		s_achSQL += &
         " AND sh_docket_disbursement.case_number = ~~~'" + s_achCaseNum + "~~~'" 
   End If
End If

If s_achCheckNum <> "" Then
	If Len(s_achSQL) = 0 Then
      s_achSQL = &
         " WHERE sh_docket_disbursement.check_number = ~~~'" + s_achCheckNum + "~~~'" 
   Else 
		s_achSQL += &
         " AND sh_docket_disbursement.check_number = ~~~'" + s_achCheckNum + "~~~'" 
   End If
End If
...
gnv_resize.of_Register(sle_casenum, gnv_resize.SCALE)
gnv_resize.of_Register(sle_checknum, gnv_resize.SCALE)
...
type cb_escape from w_base_sheet`cb_escape within w_docket_disbursements_sheet
integer taborder = 130
end type

type cb_exit from w_base_sheet`cb_exit within w_docket_disbursements_sheet
integer taborder = 220
end type

type cb_last from w_base_sheet`cb_last within w_docket_disbursements_sheet
integer taborder = 210
end type

type cb_next from w_base_sheet`cb_next within w_docket_disbursements_sheet
integer taborder = 200
end type

type cb_back from w_base_sheet`cb_back within w_docket_disbursements_sheet
integer taborder = 180
end type

type cb_first from w_base_sheet`cb_first within w_docket_disbursements_sheet
integer taborder = 170
end type

type cb_save from w_base_sheet`cb_save within w_docket_disbursements_sheet
integer taborder = 140
end type

type cb_delete from w_base_sheet`cb_delete within w_docket_disbursements_sheet
integer taborder = 120
end type

type cb_update from w_base_sheet`cb_update within w_docket_disbursements_sheet
integer taborder = 110
end type

type cb_add from w_base_sheet`cb_add within w_docket_disbursements_sheet
integer taborder = 100
end type

type cb_new from w_base_sheet`cb_new within w_docket_disbursements_sheet
integer taborder = 90
end type

type cb_clear from w_base_sheet`cb_clear within w_docket_disbursements_sheet
integer taborder = 80
end type

type cb_search from w_base_sheet`cb_search within w_docket_disbursements_sheet
integer taborder = 70
end type

type dw_detail from w_base_sheet`dw_detail within w_docket_disbursements_sheet
...
type dw_scan from w_base_sheet`dw_scan within w_docket_disbursements_sheet
integer y = 205
integer width = 3101
integer height = 512
...
type gb_5 from w_base_sheet`gb_5 within w_docket_disbursements_sheet
end type

type gb_4 from w_base_sheet`gb_4 within w_docket_disbursements_sheet
end type

type gb_1 from w_base_sheet`gb_1 within w_docket_disbursements_sheet
end type

type gb_2 from w_base_sheet`gb_2 within w_docket_disbursements_sheet
end type

type cb_list from w_base_sheet`cb_list within w_docket_disbursements_sheet
integer taborder = 150
end type

type cb_detail from w_base_sheet`cb_detail within w_docket_disbursements_sheet
integer taborder = 160
end type

type gb_3 from w_base_sheet`gb_3 within w_docket_disbursements_sheet
end type
...
dw_detail.Retrieve("D", s_iCBDisYear, s_lCBDisNum)		
dw_detail.SetRowFocusIndicator(Hand!)
