$PBExportHeader$w_inquire_docket_disbursement_sheet.srw
forward
global type w_inquire_docket_disbursement_sheet from w_base_sheet
end type
type gb_d from groupbox within w_inquire_docket_disbursement_sheet
end type
type gb_m from groupbox within w_inquire_docket_disbursement_sheet
end type
type cb_main from commandbutton within w_inquire_docket_disbursement_sheet
end type
type cb_disburse from commandbutton within w_inquire_docket_disbursement_sheet
end type
type cb_disburse_one from commandbutton within w_inquire_docket_disbursement_sheet
end type
type cb_close from commandbutton within w_inquire_docket_disbursement_sheet
end type
type dw_check from datawindow within w_inquire_docket_disbursement_sheet
end type
type cb_print_check from commandbutton within w_inquire_docket_disbursement_sheet
end type
end forward
...
global w_inquire_docket_disbursement_sheet w_inquire_docket_disbursement_sheet
...
on w_inquire_docket_disbursement_sheet.create
int iCurrent
call super::create
...
on w_inquire_docket_disbursement_sheet.destroy
call super::destroy
destroy(this.gb_d)
destroy(this.gb_m)
...
w_inquire_docket_disbursement_sheet.Title = "Docket Disbursement Information - (READ-ONLY) " + &
...
type cb_escape from w_base_sheet`cb_escape within w_inquire_docket_disbursement_sheet
integer x = 3237
integer taborder = 70
end type

type cb_exit from w_base_sheet`cb_exit within w_inquire_docket_disbursement_sheet
...
type cb_last from w_base_sheet`cb_last within w_inquire_docket_disbursement_sheet
integer x = 3485
end type

type cb_next from w_base_sheet`cb_next within w_inquire_docket_disbursement_sheet
integer x = 3485
end type

type cb_back from w_base_sheet`cb_back within w_inquire_docket_disbursement_sheet
integer x = 3485
end type

type cb_first from w_base_sheet`cb_first within w_inquire_docket_disbursement_sheet
integer x = 3485
integer taborder = 110
end type

type cb_save from w_base_sheet`cb_save within w_inquire_docket_disbursement_sheet
integer x = 3237
integer taborder = 80
end type

type cb_delete from w_base_sheet`cb_delete within w_inquire_docket_disbursement_sheet
integer x = 3237
end type

type cb_update from w_base_sheet`cb_update within w_inquire_docket_disbursement_sheet
integer x = 3237
end type
...
type cb_add from w_base_sheet`cb_add within w_inquire_docket_disbursement_sheet
integer x = 3237
end type

type cb_new from w_base_sheet`cb_new within w_inquire_docket_disbursement_sheet
integer x = 3237
end type

type cb_clear from w_base_sheet`cb_clear within w_inquire_docket_disbursement_sheet
integer x = 3237
end type

type cb_search from w_base_sheet`cb_search within w_inquire_docket_disbursement_sheet
integer x = 3237
end type

type dw_detail from w_base_sheet`dw_detail within w_inquire_docket_disbursement_sheet
...
type dw_scan from w_base_sheet`dw_scan within w_inquire_docket_disbursement_sheet
integer x = 22
integer y = 26
integer width = 3160
integer height = 838
...
type gb_5 from w_base_sheet`gb_5 within w_inquire_docket_disbursement_sheet
integer x = 3460
end type

type gb_4 from w_base_sheet`gb_4 within w_inquire_docket_disbursement_sheet
integer x = 3460
end type

type gb_1 from w_base_sheet`gb_1 within w_inquire_docket_disbursement_sheet
integer x = 3211
integer textsize = -9
end type

type gb_2 from w_base_sheet`gb_2 within w_inquire_docket_disbursement_sheet
integer x = 3211
end type

type cb_list from w_base_sheet`cb_list within w_inquire_docket_disbursement_sheet
integer x = 3485
integer taborder = 90
end type

type cb_detail from w_base_sheet`cb_detail within w_inquire_docket_disbursement_sheet
integer x = 3485
integer taborder = 100
end type

type gb_3 from w_base_sheet`gb_3 within w_inquire_docket_disbursement_sheet
integer x = 3460
end type
