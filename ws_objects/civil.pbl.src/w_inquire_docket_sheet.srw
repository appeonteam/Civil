$PBExportHeader$w_inquire_docket_sheet.srw
forward
global type w_inquire_docket_sheet from w_base_sheet
end type
type st_1 from statictext within w_inquire_docket_sheet
end type
type sle_lname from singlelineedit within w_inquire_docket_sheet
end type
type st_2 from statictext within w_inquire_docket_sheet
end type
type sle_fname from singlelineedit within w_inquire_docket_sheet
end type
type st_memo from statictext within w_inquire_docket_sheet
end type
type cb_pclip from commandbutton within w_inquire_docket_sheet
end type
type st_6 from statictext within w_inquire_docket_sheet
end type
type sle_feebook from singlelineedit within w_inquire_docket_sheet
end type
type cb_served from commandbutton within w_inquire_docket_sheet
end type
type cb_fees from commandbutton within w_inquire_docket_sheet
end type
type cb_billable from commandbutton within w_inquire_docket_sheet
end type
type cb_memo from commandbutton within w_inquire_docket_sheet
end type
type cb_name from commandbutton within w_inquire_docket_sheet
end type
type cb_main from commandbutton within w_inquire_docket_sheet
end type
type gb_9 from groupbox within w_inquire_docket_sheet
end type
type gb_8 from groupbox within w_inquire_docket_sheet
end type
type gb_6 from groupbox within w_inquire_docket_sheet
end type
type cb_return from commandbutton within w_inquire_docket_sheet
end type
type dw_return_service from datawindow within w_inquire_docket_sheet
end type
type cb_serv_slip from commandbutton within w_inquire_docket_sheet
end type
type dw_serv_slip from datawindow within w_inquire_docket_sheet
end type
type sle_dock_year from singlelineedit within w_inquire_docket_sheet
end type
type sle_dock_num from singlelineedit within w_inquire_docket_sheet
end type
type st_7 from statictext within w_inquire_docket_sheet
end type
type st_8 from statictext within w_inquire_docket_sheet
end type
type cb_bill_letter from commandbutton within w_inquire_docket_sheet
end type
type dw_bill_letter from datawindow within w_inquire_docket_sheet
end type
type em_rec_date from editmask within w_inquire_docket_sheet
end type
type st_9 from statictext within w_inquire_docket_sheet
end type
type cb_receipt from commandbutton within w_inquire_docket_sheet
end type
type cb_disbursement from commandbutton within w_inquire_docket_sheet
end type
type gb_7 from groupbox within w_inquire_docket_sheet
end type
type cb_balance_due from commandbutton within w_inquire_docket_sheet
end type
type st_served from statictext within w_inquire_docket_sheet
end type
type st_diligent from statictext within w_inquire_docket_sheet
end type
type st_fee_total_text from statictext within w_inquire_docket_sheet
end type
type st_fee_total from statictext within w_inquire_docket_sheet
end type
type st_receipt from statictext within w_inquire_docket_sheet
end type
end forward
...
integer width = 3690
integer height = 2141
string title = "Inquiry Docket Information - (READ-ONLY)    F9"
...
st_fee_total_text st_fee_total_text
st_fee_total st_fee_total
st_receipt st_receipt
end type
global w_inquire_docket_sheet w_inquire_docket_sheet
...
on w_inquire_docket_sheet.create
int iCurrent
call super::create
...
this.st_fee_total_text=create st_fee_total_text
this.st_fee_total=create st_fee_total
...
this.Control[iCurrent+36]=this.st_fee_total_text
this.Control[iCurrent+37]=this.st_fee_total
this.Control[iCurrent+38]=this.st_receipt
end on

on w_inquire_docket_sheet.destroy
call super::destroy
destroy(this.st_1)
...
destroy(this.st_fee_total_text)
destroy(this.st_fee_total)
...
// Received Date
If s_achRec <> "" And s_achRec <> "00/00/0000" And Not IsNull(s_achRec) Then
	If Len(s_achSQL) = 0 Then
		s_achSQL = &
...
Else
	...
	// Full Inquiry Features
	If w_main.dw_perms.Find("code=69", 1, w_main.dw_perms.RowCount()) > 0 Then
...
gnv_resize.of_Register(st_fee_total, gnv_resize.SCALE)
gnv_resize.of_Register(st_fee_total_text, gnv_resize.SCALE)
			...
			If i_achMode = "Continue" And i_bNew = True Then
				If i_achOpType = "Add" Then
					If 1 = MessageBox("Docket Parties Involved Information", &
						"Add Docket Parties Involved Information?",Question!,YesNo!,1) Then
...
*/						
			...
			st_fee_total.text = string(s_dtotfees,'#,##0.00')				
...
type cb_escape from w_base_sheet`cb_escape within w_inquire_docket_sheet
integer taborder = 130
end type

type cb_exit from w_base_sheet`cb_exit within w_inquire_docket_sheet
integer taborder = 210
end type

type cb_last from w_base_sheet`cb_last within w_inquire_docket_sheet
integer taborder = 200
end type

type cb_next from w_base_sheet`cb_next within w_inquire_docket_sheet
integer taborder = 190
end type

type cb_back from w_base_sheet`cb_back within w_inquire_docket_sheet
integer taborder = 180
end type

type cb_first from w_base_sheet`cb_first within w_inquire_docket_sheet
integer taborder = 170
end type

type cb_save from w_base_sheet`cb_save within w_inquire_docket_sheet
integer taborder = 140
end type

type cb_delete from w_base_sheet`cb_delete within w_inquire_docket_sheet
integer taborder = 120
end type

type cb_update from w_base_sheet`cb_update within w_inquire_docket_sheet
integer taborder = 110
end type

type cb_add from w_base_sheet`cb_add within w_inquire_docket_sheet
integer taborder = 100
end type

type cb_new from w_base_sheet`cb_new within w_inquire_docket_sheet
integer taborder = 90
end type

type cb_clear from w_base_sheet`cb_clear within w_inquire_docket_sheet
integer taborder = 80
end type

type cb_search from w_base_sheet`cb_search within w_inquire_docket_sheet
integer taborder = 70
end type

type dw_detail from w_base_sheet`dw_detail within w_inquire_docket_sheet
...
type dw_scan from w_base_sheet`dw_scan within w_inquire_docket_sheet
integer x = 22
integer y = 189
integer width = 3072
integer height = 467
...
Choose Case dw_detail.DataObject
	Case "dw_docket_scan"
		...
		dw_scan.SelectRow(0,False)
		dw_scan.SelectRow(row, True)
		
End Choose
*/
end event

type gb_5 from w_base_sheet`gb_5 within w_inquire_docket_sheet
end type

type gb_4 from w_base_sheet`gb_4 within w_inquire_docket_sheet
end type

type gb_1 from w_base_sheet`gb_1 within w_inquire_docket_sheet
end type

type gb_2 from w_base_sheet`gb_2 within w_inquire_docket_sheet
end type

type cb_list from w_base_sheet`cb_list within w_inquire_docket_sheet
integer taborder = 150
end type

type cb_detail from w_base_sheet`cb_detail within w_inquire_docket_sheet
integer taborder = 160
end type

type gb_3 from w_base_sheet`gb_3 within w_inquire_docket_sheet
end type
...
event clicked;string s_achexecute, s_achexecute2
...
st_fee_total.visible = False
st_fee_total_text.visible = False
...
OpenSheetWithParm(w_inquire_docket_receipt_sheet,s_stparms,w_main, 0, Layered!)
...
OpenSheetWithParm(w_inquire_docket_disbursement_sheet,s_stparms,w_main, 0, Layered!)
