$PBExportHeader$w_print_civil_checks_rpt.srw
forward
global type w_print_civil_checks_rpt from w_base_no_criteria_scan
end type
type cb_generate from commandbutton within w_print_civil_checks_rpt
end type
type em_start from editmask within w_print_civil_checks_rpt
end type
type em_end from editmask within w_print_civil_checks_rpt
end type
type st_end from statictext within w_print_civil_checks_rpt
end type
type st_start from statictext within w_print_civil_checks_rpt
end type
type sle_beg_check from singlelineedit within w_print_civil_checks_rpt
end type
type sle_end_check from singlelineedit within w_print_civil_checks_rpt
end type
type st_dash from statictext within w_print_civil_checks_rpt
end type
type st_range from statictext within w_print_civil_checks_rpt
end type
type ddlb_fee_type from dropdownlistbox within w_print_civil_checks_rpt
end type
type st_1 from statictext within w_print_civil_checks_rpt
end type
end forward
...
string Title="Print Docket Checks"
...
global w_print_civil_checks_rpt w_print_civil_checks_rpt
...
on w_print_civil_checks_rpt.create
int iCurrent
call super::create
...
on w_print_civil_checks_rpt.destroy
call super::destroy
...
type cb_view from w_base_no_criteria_scan`cb_view within w_print_civil_checks_rpt
int TabOrder=0
boolean Visible=false
end type

type cb_print from w_base_no_criteria_scan`cb_print within w_print_civil_checks_rpt
int X=2878
int Y=51
int Width=315
int Height=96
...
type cb_update from w_base_no_criteria_scan`cb_update within w_print_civil_checks_rpt
int TabOrder=0
boolean Visible=false
end type

type dw_scan from w_base_no_criteria_scan`dw_scan within w_print_civil_checks_rpt
int X=29
int Y=182
int Width=3500
int Height=1680
...
type cb_exit from w_base_no_criteria_scan`cb_exit within w_print_civil_checks_rpt
int X=3215
int Y=51
int Width=315
int Height=96
...
type cb_delete from w_base_no_criteria_scan`cb_delete within w_print_civil_checks_rpt
int TabOrder=0
boolean Visible=false
end type

type cb_add from w_base_no_criteria_scan`cb_add within w_print_civil_checks_rpt
int TabOrder=0
boolean Visible=false
end type
...
dw_scan.Reset()
If dw_scan.Retrieve('W', 'D', 'FEE', s_lBegCheck, s_lEndCheck) = 0 Then
...
boolean Enabled=false
boolean BringToTop=true
string Text="Docket - Check Range:"
Alignment Alignment=Right!
boolean FocusRectangle=false
long TextColor=33554432
long BackColor=12632256
